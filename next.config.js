    ...
    return [
      {
        ...
        headers: nextSafe({ 
          contentSecurityPolicy: {
            ...
            "connect-src": `'self' ws: https://clerk.tough.robin-87.lcl.dev https://matomo.njf.dev http://localhost:54321 https://umami.njf.dev https://sikyjryusjyiiehfhxmp.supabase.co`,
            "frame-src": `'self' https://js.stripe.com https://clerk.tough.robin-87.lcl.dev`,
            "img-src": `'self' data: https://*.stripe.com https://sikyjryusjyiiehfhxmp.supabase.co https://images.clerk.dev`,
