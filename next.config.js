    ...
    return [
      {
        ...
        headers: nextSafe({ 
          contentSecurityPolicy: {
            ...
            "connect-src": `'self' https://${process.env.NEXT_PUBLIC_CLERK_FRONTEND_API} http://localhost:54321 https://umami.njf.dev https://sikyjryusjyiiehfhxmp.supabase.co`,
            "frame-src": `'self' https://${process.env.NEXT_PUBLIC_CLERK_FRONTEND_API}`,
            "img-src": `https://images.clerk.dev/static/github.svg`,
          },
        }),
      },
    ]
